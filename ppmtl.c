...
int print_ip_args( int argc, char *argv[] )
{
	int i;
	for ( i = 0; i< argc; i++ )
	{
...
int read_eval_ip_param( int argc, char *argv[], char *key_file_name )
{
	int err = 0, i;

	if ( key_file_name == NULL )
	{
		fprintf(stderr, "Invalid parameter: key_file_name:%s!", key_file_name);
		return -2;
	}
